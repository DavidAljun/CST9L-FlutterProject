...
Map<WidgetType, Widget Function()> widgetBuilders = {
  WidgetType.LamzuAtlantis: () => LargeMouse(),
  WidgetType.LamzuThorn: () => MediumMouse(),
  // Add more mappings for other widget types if needed
};

class SmallMouse extends StatefulWidget {
  const SmallMouse({Key? key}) : super(key: key);

  @override
  State<SmallMouse> createState() => _MySmallMouse();
}

class _MySmallMouse extends State<SmallMouse>
    ...
    try {
      QuerySnapshot<Map<String, dynamic>> querySnapshot =
          await FirebaseFirestore.instance
              ...
              .where('DocumentID', isEqualTo: 'SMALL MOUSE')
              .where('ItemQuantity',
                  isGreaterThan:
      ...
      if (querySnapshot.docs.isNotEmpty) {
        ...
        print('No document found with DocumentID: SMALL MOUSE');
      }
    } catch (e) {
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(left: 8.0),
                                      child: Text(
                                        "Semi-Ambidextrous Shape for Fingertip and Claw Grip & designed for the Perfect Feel mouse",
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(left: 8.0),
                                      child: Text(
                                        "PAW3395 optical sensor and No-lag wireless connectivity with up to 4k polling rate",
                                        textAlign: TextAlign.justify,
                                        textDirection: TextDirection.ltr,
                                        style: GoogleFonts.mPlus1(
                                          color: const Color.fromARGB(
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(left: 8.0),
                                      child: Text(
                                        "Supports up to 26000 DPI with High battery life up to 90 hours",
                                        textAlign: TextAlign.justify,
                                        textDirection: TextDirection.ltr,
                                        style: GoogleFonts.mPlus1(
                                          color: const Color.fromARGB(
