...
class MediumMouse extends StatefulWidget {
  const MediumMouse({Key? key}) : super(key: key);

  @override
  State<MediumMouse> createState() => _MyMediumMouse();
}

class _MyMediumMouse extends State<MediumMouse>
    ...
    try {
      QuerySnapshot<Map<String, dynamic>> querySnapshot =
          await FirebaseFirestore.instance
              ...
              .where('DocumentID', isEqualTo: 'MEDIUM MOUSE')
              .where('ItemQuantity',
                  isGreaterThan:
      ...
      if (querySnapshot.docs.isNotEmpty) {
        ...
        print('No document found with DocumentID: MEDIUM MOUSE');
      }
    } catch (e) {
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(left: 8.0),
                                      child: Text(
                                        "Ergonomic Shape for Palm Grip & designed for hardcore mouse",
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(left: 8.0),
                                      child: Text(
                                        "Supports up to 26000 DPI with High battery life up to 80 hours",
                                        textAlign: TextAlign.justify,
                                        textDirection: TextDirection.ltr,
                                        style: GoogleFonts.mPlus1(
                                          color: const Color.fromARGB(
